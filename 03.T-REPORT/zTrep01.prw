...
Static Function zOpc(nRadOpc)
   ...
   Do Case
        Case nRadOpc == 1 //--Nfs de ENTRADA
            FWMsgRun( ,{|| U_ZTREP02() } ,"Carregando relatório de NFs de entrada!" ,"Por favor aguarde...")
        Case nRadOpc == 2 //--Nfs de SAÍDA
            FWMsgRun( ,{|| U_ZTREP03() } ,"Carregando relatório de NFs de saída!" ,"Por favor aguarde...")
    EndCase
