...
Static _cCLIENTE As Character //Variável de retorno.
...
Data.....:              14/02/24
Descricao / Objetivo:   Função responasvel por consulta padrão específica dos códigos de compradores. 
Doc. Origem:            
Solicitante:            
Uso......:              
Obs......:              https://erplabs.com.br/consulta-especifica-com-retorno-em-variavel/ 
=====================================================================================
*/
User Function ZCOES01()
...
//Esta função é colocada no campo de retorno ao cadastrar uma 'Nova consulta'.
User Function zCOES01A()
...
Static Function fMontaTela()
    ...
    DEFINE MSDIALOG oDlg TITLE "Cadastro de Compradores" FROM 000, 000 TO nJanAltu,nJanLarg COLORS 0, 16777215 PIXEL
        ...
        //Dados
        oPanGrid := tPanel():New(002, 002, '', oDlg, , , , RGB(000,000,000), RGB(254,254,254), ((nJanLarg/2)-1),133) 
